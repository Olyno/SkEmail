...
public class EffDisconnection extends AsyncEffect {
    ...
    static {
        registerAsyncEffect(EffDisconnection.class,
    ...
    public boolean initAsync(Expression<?>[] expr, int matchedPattern, Kleenean isDelayed, SkriptParser.ParseResult parseResult) {
