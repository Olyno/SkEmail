...
@Name("Yahoo UK service")
@Description("Returns the yahoo uk service as EmailService.")
@Examples({
        "set {_service} to new yahoo uk service"
})
@Since("1.4")

public class YahooUK extends SimpleExpression<EmailService> {

    static {
        Skript.registerExpression(YahooUK.class, EmailService.class, ExpressionType.SIMPLE,
                "[new] yahoo uk [(service|session)]");
    }
